    ...
    async function fetchGameState(userAddress = null) {
        try {
            ...
            if (data.blaze) {
                ...
                console.log('[Blockchain] *** userNeedsApproval:', State.blockchainData.blaze.userNeedsApproval);
                console.log('[Blockchain] *** wethAccumulated (claimable):', State.blockchainData.blaze.wethAccumulatedFormatted);
            }
